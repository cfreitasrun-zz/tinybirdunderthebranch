...
<div class="crp-portfolio-header">
    ...
    <div class="crp-three-parts crp-fr">
        ...
        <a id="crp-portfolio-options-button" class='button-secondary portfolio-button crp-fr tooltip' title="<div class='crp-tooltip-content'>Upgrade to Premium version for settings customization!</div>" href="#" onclick="onPortfolioOptions()">
    ...
    if(crp_portfolio.projects && crp_portfolio.corder){
        for(var crp_projectIndex = 0; crp_projectIndex < crp_portfolio.corder.length; crp_projectIndex++){
            ...
            if(crp_project.id == crp_selectedProjectId){
                ...
                for (var tagI=0; tagI<tags.length; tagI++){ jQuery('#crp-project-categories').tagEditor('removeTag', htmlEntitiesEncode(tags[tagI])); }
